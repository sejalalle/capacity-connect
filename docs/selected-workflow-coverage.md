# Selected competency-development workflow
...
|15|Completion certificates|MISSING|Active API, conditions, PDF, issuance and revocation|
|16|Workplace follow-up|PARTIAL|Existing actions; add scoped observations and reminders|
